...
import type { PresenceUser, AppSession } from "@/shared/types";
        ...
        {session?.user ? (
          <div className="relative">
            <button
              ...
              className="flex h-9 items-center gap-2 rounded-md border border-gray-200/90 bg-white px-2.5 shadow-xs hover:bg-gray-50 active:scale-95 transition"
            ...
            <AnimatePresence>
              {userMenuOpen && (
                <motion.div
                  ...
                  exit={{ opacity: 0, scale: 0.95, y: -4 }}
                  transition={{ duration: 0.15 }}
                  className="absolute right-0 top-11 w-52 rounded-md border border-gray-200/90 bg-white p-1.5 shadow-xl z-50 select-none text-xs"
                >
                  ...
                  <Link
                    ...
                    className="flex w-full items-center gap-2.5 rounded-md px-2.5 py-1.5 text-gray-700 hover:bg-gray-100 transition font-medium"
                  >
                  ...
                  <button
                    ...
                    className="flex w-full items-center gap-2.5 rounded-md px-2.5 py-1.5 text-rose-600 hover:bg-rose-50 transition font-medium text-left"
                  >
          ...
          <Link
            href={`/sign-in${boardId ? `?redirectTo=/boards/${boardId}` : ""}`}
            className="flex h-9 items-center gap-1.5 rounded-md border border-gray-200/90 bg-white px-3.5 text-xs font-semibold text-gray-700 shadow-xs hover:bg-gray-50 hover:text-gray-900 active:scale-95 transition"
