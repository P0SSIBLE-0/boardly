export const SCHEMA_STATEMENTS = [
  ...
  `CREATE UNIQUE INDEX IF NOT EXISTS board_share_links_token_unique ON board_share_links(token);`,
  `CREATE INDEX IF NOT EXISTS board_share_links_board_idx ON board_share_links(board_id);`,
];
